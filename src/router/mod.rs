...
pub fn build(state: AppState) -> Router {
    let authed = Router::new()
        ...
        // ── Document production ────────────────────────────────────────────
        .route("/projects/:id/documents/available",                get(project_documents::available))
        .route("/projects/:id/documents",                          post(project_documents::produce))
