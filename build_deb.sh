...
#   /usr/lib/kubuno/modules/office/{kubuno-office, module.toml, frontend/}
#   /usr/share/kubuno/modules/office/migrations/*.sql
#   /etc/kubuno/modules/office/config.toml.example
#
# Usage :
