...
- **Database driver updated past an unfixable advisory.** The previous line
  ...
  has been audited — every query here was traced back to its source and
  rewritten so the compiler itself proves the statement is a fixed literal.
...
[Unreleased]: https://github.com/kubuno/office/compare/v0.1.7...HEAD
[0.1.7]: https://github.com/kubuno/office/releases/tag/v0.1.7
